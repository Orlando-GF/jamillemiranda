                    ...
                    >
                        ...
                        <div className="bg-white p-6 md:p-10 border border-gold/30 shadow-2xl relative z-10 transition-all duration-500 group-hover:border-gold/50">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div className="flex items-center justify-center gap-2 text-[10px] text-gold/60 uppercase tracking-[0.2em] pt-4 font-bold border-t border-gold/10 mt-2">
                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                    </svg>
                                    <span>Ambiente Seguro SSL • Seus dados estão protegidos</span>
                                </div>
                            </form>
                        </div>
                    </motion.div>
                        ...
                        <div className="space-y-10 pl-2">
                            {[
                                ...
                                },
                                {
                                    ...
                                    icon: (props: React.SVGProps<SVGSVGElement>) => <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
                                },
                                {
                                    label: "Endereço da Clínica",
                                    value: <>Rua das Flores, 123, Sala 401 -<br />Centro, Cidade - UF</>,
                                    icon: (props: React.SVGProps<SVGSVGElement>) => <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
                                }
                            ].map((item, idx) => (
